...
type Receipt struct {
	...
	TelegramType TeleType
}

func (r *Receipt) IsLegacyTx() bool {
	return r.TelegramType == LegacyTx
}
...
func (r *Receipt) SetApplicationAddress(applicationAddress Address) {
	r.ApplicationAddress = &applicationAddress
}
